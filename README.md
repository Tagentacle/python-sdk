...
See `examples/bringup_pkg/config/secrets.toml.example` for the template.
...
│   └── src/
│       ├── agent_pkg/.venv → ../../examples/agent_pkg/.venv
│       └── mcp_server_pkg/.venv → ../../examples/mcp_server_pkg/.venv
└── examples/
    ├── agent_pkg/.venv/            # real venv (created by uv sync)
    └── mcp_server_pkg/.venv/       # real venv (created by uv sync)
```
...
├── examples/
│   ├── agent_pkg/               # Example MCP client agent
│   │   ├── pyproject.toml       # uv project config
│   │   └── tagentacle.toml      # Package manifest
│   ├── mcp_server_pkg/          # Example MCP weather server
│   │   ├── pyproject.toml
│   │   └── tagentacle.toml
